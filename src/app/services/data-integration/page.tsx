    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontWeight: "200" }}> Struggling With</span>{" "}
            <span style={{ color: colors.secondary }}>E-Commerce</span> System
            Integration?
          </div>
          <div
            style={{ color: "black" }}
          ...
          <div
            style={{ color: "#000", textAlign: "center", maxWidth: "40rem" }}
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className={styles.contentContainerRow}
          style={{ width: isMobile ? " " : "clamp(40rem,65vw,65rem)" }}
        >
          <div
            style={{
              display: "flex",
      ...
      >
        ...
        {isMobile ? (
          ...
          <motion.div
            ...
            animate={controls6}
            transition={{ duration: 0.5 }}
            style={{ width: "clamp(10rem,90vw,100rem)", alignSelf: "center" }}
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.91 }}
          >
            <Image
        ...
        <ContactForm id="contactForm" containerStyles={{ marginTop: "8rem" }} />
      </div>
    </div>
  );
};
