          ...
          <div className={styles.flexRow}>
            <div style={{ marginTop: isMobile ? "" : "2rem" }}>
              ...
              <div
                ...
                style={{ fontSize: isMobile ? "" : "3.7rem" }}
              >
      ...
      >
        <div className={styles.refactorContainer}>
              ...
              <div style={{ marginTop: isMobile ? "" : "2rem" }}>
                ...
                <div>
                  ...
                  <Image
                    ...
                    className={styles.flowImg}
                    style={{
                      marginTop: isMobile ? "1vw" : "1rem",
                      marginBottom: isMobile ? "2vw" : "1rem",
                    }}
                  />
                </div>
              </div>
          ...
          >
            ...
            >
              <div style={{ marginTop: isMobile ? "2vw" : "2rem" }}>
                <div
                  className={styles.numberStyles}
                  style={{
                    color: colors.secondary,
        ...
        {isMobile ? (
          ...
          >
            ...
            >
              ...
              complexities of microservices architecture. <br />
              <br />
              If you&apos;re considering migrating to AWS Lambda, our expert
              team will streamline the process for maximum efficiency, from
              careful planning and automated conversion to comprehensive
              redesign and optimization. Take your microservices to the next
              level with Ace8.
            </div>
            <motion.button
              style={{
          ...
          <motion.div
            style={{ marginTop: "10rem", alignSelf: "center" }}
