...
const CustomerStories = [
  {
    ...
    content: `<strong>Customer Background:</strong>
...
<strong>Navigating the Transition: C++ to Java:</strong>
...
<strong>Strategic Approach: Conversion Tools and Precision:</strong>
...
<strong>Triumph of Launch: A Seamless Unveiling:</strong>
...
<strong>Epilogue: A Journey of Transformation and Victory:</strong>
...
The narrative stands as an embodiment of strategic partnership and technological acumen, underscoring the triumph that emerges when challenges are met with innovative\nsolutions.  `,
  },
  {
    ...
    content: `<strong>Customer Name:</strong>
...
<strong>Migration Requirement:</strong>
...
<strong>AceIT Consulting Solution:</strong>
...
<strong>1. Assessment and Planning:</strong>
...
<strong>2. Conversion Tools Development:</strong>
...
<strong>4. Integration and Testing:</strong>
...
<strong>5. Deployment and Monitoring:</strong>
...
<strong>Successful Outcome:</strong>
...
<strong>The MVP Leap:</strong>
<strong>CloudFormation Templates:</strong>
...
<strong>Evolution of Excellence:</strong>
...
<strong>Triumph of On-Time Launch:</strong>
...
<strong>Epilogue: A Tale of IaC Empowerment:</strong>
