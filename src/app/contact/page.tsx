  ...
  function handleSubmit(event:any){
    ...
    description: descriptionRef.current?.value || ''
      ...
      axios({
        ...
        data: JSON.stringify({
          subject: "This is a Contact Us request form Ace8",
          message: formData,
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{
              width: isMobile ? "60vw" : "19rem",
              height: isMobile ? "15vw" : "5.5rem",
              borderRadius: isMobile ? "2vw" : ".5rem",
              backgroundColor: "rgba(35, 35, 35, 1)",
              position: "absolute",
              bottom: isMobile ? "-6vw" : "-2rem",
              display: "flex",
          ...
          >
            <div>
              ...
              <div style={{ fontSize: isMobile ? "2.8vw" : ".9rem" }}>
                info@ace8.io
              </div>
            </div>
            <div>
